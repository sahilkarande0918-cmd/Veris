...
def _prompt(payload: dict, language: str, stricter: bool) -> list[dict]:
    ...
    system = (
        ...
        "of a crime.\n"
        "- Speak straight to the user ('this link', 'you'). Never mention scores, "
        "weights, signals, rules, or 'the system' -- those are internals, not advice.\n"
        "- Translate technical words rather than transliterating them; a reader with "
        "no English should still understand.\n"
